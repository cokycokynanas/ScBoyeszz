Tentu, saya akan mengganti nama author dalam script Lua yang Anda berikan menjadi Boyeszz (sesuai dengan nama kontak yang tertera di teks awal, yaitu @Boyeszz).
Berikut adalah bagian-bagian yang diubah (yang relevan):
 * Nama Window Utama:
   * Dari: "BangBoyeszz Tools"
   * Menjadi: "Boyeszz Tools"
 * Loading Subtitle:
   * Dari: "Just a Simple Script By Boyeszz♡"
   * Menjadi: "Just a Simple Script By Boyeszz"
 * Warning/Notify wrapper:
   * Dari: warn("[BangBoyeszz Tools] " .. tostring(msg))
   * Menjadi: warn("[Boyeszz Tools] " .. tostring(msg))
Berikut adalah script lengkap yang sudah diperbarui:
...
local function notify(msg)
    if Rayfield and Rayfield.Notify then
        ...
        warn("[Boyeszz Tools] " .. tostring(msg)) -- Diubah dari [BangBoyeszz Tools]
    end
end
...
local function CreateUI()
    ...
    local Window = Rayfield:CreateWindow({
        Name = "Boyeszz Tools", -- Diubah dari "BangBoyeszz Tools"
        LoadingTitle = "Boyeszz Tools", -- Diubah dari "BangBoyeszz Tools"
        LoadingSubtitle = "Just a Simple Script By Boyeszz", -- Diubah dari "Just a Simple Script By Boyeszz♡"
...
Apakah ada bagian lain dalam script ini yang ingin Anda modifikasi atau jelaskan?
