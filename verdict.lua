...
local function LoadUI()
    ...
    if game.PlaceId == 121864768012064 then
        -- notify using original notify
        notify("Game terdeteksi: Fish It. Tab khusus diaktifkan!")
...
-- // Monitor game changes & reload UI (so Fish It tab is removed completely when leaving)
task.spawn(function()
